...
class LeitnerSpacing():
    def __init__(self, flash_cards):
        ...
        for word, definition in flash_cards:
    ...
    def __str__(self):
        return str([[fc.word for fc in self.boxes[idx]] for idx in range(5)])
